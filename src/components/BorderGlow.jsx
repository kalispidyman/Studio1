...
const BorderGlow = ({
  ...
  fillOpacity = 0.5,
  // =========================================================================
  // 🎯 BORDERGLOW SIZE & POSITION CONTROLS
  // =========================================================================
  // Width:  Use '400px', '50%', '100%', '20rem' etc.
  // Height: Use '300px', '100%', '20rem' etc.
  // X:      Horizontal offset in pixels (positive = right, negative = left)
  // Y:      Vertical offset in pixels (positive = down, negative = up)
  // =========================================================================
  width = null,       // Set to override card width (e.g. '400px')
  height = null,      // Set to override card height (e.g. '300px')
  x = 0,              // X-axis offset in px (e.g. 50 moves right, -50 moves left)
  y = 0,              // Y-axis offset in px (e.g. 30 moves down, -30 moves up)
}) => {
  ...
  return (
    <div
      ...
      style={{
        ...
        transform: `translate3d(${typeof x === 'number' ? x + 'px' : x}, ${typeof y === 'number' ? y + 'px' : y}, 0.01px)`,
