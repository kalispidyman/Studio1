      ...
      <div className="max-w-4xl mx-auto z-10 relative">
        ...
        <div className="mb-12 border-b border-white/10 pb-8">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-[10px] font-mono uppercase tracking-[0.4em] text-primary/80">Legals</span>
          </div>
        ...
        <div className="bg-[#0a0a0c]/60 backdrop-blur-2xl border border-white/5 rounded-[2rem] p-6 md:p-10 text-neutral-300 text-sm leading-relaxed space-y-8 shadow-2xl">
          ...
          <div className="bg-primary/5 border border-primary/10 rounded-2xl p-6 text-xs text-neutral-300 space-y-3">
            <div className="flex items-center gap-2 font-bold text-white text-sm">
              ...
              <span>LEGAL AGREEMENT SUMMARY</span>
            </div>
            <p>
              By accessing this webpage, you are agreeing to be bound by these Terms and Conditions (“Terms”) in a legally binding agreement between Neet operating as Studio1 (“Merchant”, “us”, “we”, or “our”) and the User (“you” or “your”). Please read these Terms carefully before accessing or using the Website. If you do not agree to the Terms, you may not access the Platform.
            </p>
            <p>
          ...
          <div>
            <h2 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
              <span className="text-primary font-mono">1.</span> ELIGIBILITY
            </h2>
            <p>
          ...
          <div>
            <h2 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
              <span className="text-primary font-mono">2.</span> DEFINITIONS
            </h2>
            <div className="space-y-4 font-normal pl-4 border-l border-white/5">
              <p>
                <strong className="text-white font-mono">“Payment Instrument”</strong> includes credit card, debit card, bank account, prepaid payment instrument, Unified Payment Interface (UPI), Immediate Payment Service (IMPS) or any other methods of payments which shall be developed or added or deployed by banks and financial institutions from time to time.
              </p>
              <p>
                <strong className="text-white font-mono">“Platform”</strong> refers to the website <a href="https://neetstudios.vercel.app" target="_blank" rel="noreferrer" className="text-primary underline">https://neetstudios.vercel.app</a> where the Merchant offers its products or services and where the Transaction may be initiated.
              </p>
              <p>
                <strong className="text-white font-mono">“Transaction”</strong> shall refer to the order or request placed by the User with the Merchant to purchase the products and/or services listed on the Platform by paying the Transaction Amount to the Merchant.
              </p>
              <p>
                <strong className="text-white font-mono">“Transaction Amount”</strong> shall mean the amount paid by the User in connection with a Transaction.
              </p>
              <p>
                <strong className="text-white font-mono">“User/Users”</strong> means any person availing the products and/or services offered on the Platform.
              </p>
              <p>
                <strong className="text-white font-mono">“Website”</strong> shall mean <a href="https://neetstudios.vercel.app" target="_blank" rel="noreferrer" className="text-primary underline">https://neetstudios.vercel.app</a>.
              </p>
            </div>
          </div>
          ...
          <div>
            <h2 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
              <span className="text-primary font-mono">3.</span> MERCHANT'S RIGHTS
            </h2>
            <p>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2.5 pl-2 text-neutral-400 text-xs">
          ...
          <div>
            <h2 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
              <span className="text-primary font-mono">7.</span> GUIDELINES FOR REVIEWS
            </h2>
            <p className="mb-4">
            ...
            <ul className="list-disc list-inside space-y-2 pl-2 text-neutral-400 text-xs mb-4">
          ...
          <div>
            <h2 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
              <span className="text-primary font-mono">8.</span> GOVERNING LAWS & DISPUTE RESOLUTION
            </h2>
            <p>
          ...
          <div>
            <h2 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
              <span className="text-primary font-mono">9.</span> GRIEVANCE REDRESSAL
            </h2>
            <p>
              You agree that if you have any question or complaint with regard to any product and/or service availed on our Platform, or pertaining to the Transaction, including but not limited to, double debit of Transaction Amount, fraudulent Transaction, unauthorized Transaction, refund requests, etc., you may reach out to us at our official public contact details or by emailing us directly via the contact channels listed on <a href="https://neetstudios.vercel.app/contact/" target="_blank" rel="noreferrer" className="text-primary underline font-mono">https://neetstudios.vercel.app/contact/</a>.
            </p>
          </div>

          <div>
            <h2 className="text-lg font-bold text-white mb-3 flex items-center gap-2">
              <span className="text-primary font-mono">10.</span> DISCLAIMER
            </h2>
            <ul className="list-disc list-inside space-y-3.5 pl-2 text-neutral-300 text-xs">
              ...
              <li>That you shall provide accurate payment details to the secure payment system for making purchases on the Platform. The information provided by you may be utilized or shared with any third party if required in relation to fraud verifications or by law, regulation or court order. We expressly disclaim all liabilities that may arise as a consequence of any unauthorized use of a User’s Payment Instrument.</li>
              ...
              <li>The content on our Platform is provided for general information only. The information provided does not amount to advice from us in any manner and should not be relied upon.</li>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-neutral-600">
            © 2026 Studio1. All legal rights reserved.
          </p>
        </div>
      </div>
    </div>
